...
pigz -p ${n_thread} ${run}.halflinker.fastq 2>> ${log_file}
pigz -p ${n_thread} ${run}.fulllinker.chimeric.paired.fastq 2>> ${log_file}
pigz -p ${n_thread} ${run}.fulllinker.chimeric.single.fastq 2>> ${log_file}
pigz -p ${n_thread} ${run}.FullLinker.NonChimeric.paired.fastq 2>> ${log_file}
pigz -p ${n_thread} ${run}.FullLinker.NonChimeric.single.fastq 2>> ${log_file}
...
### BAM --> pairs --> hic
# BAM to pairs
paired_tag_bam="${run}.${tag_name}.UU.nr.bam"
...
###############
############### 2d. Map "fulllinker, chimeric, one tag" reads

tag_name="fulllinker.chimeric.single"
map_qual=30
suffix="UxxU"
...
###############
############### 2f. Map "FullLinker, NonChimeric, one tag" reads

tag_name="FullLinker.NonChimeric.single"
map_qual=30
suffix="xx"
...
###############
############### 2g. Map "FullLinker, NonChimeric, two tag" reads

tag_name="FullLinker.NonChimeric.paired"
map_qual=30
suffix="UxxU"
...
then
    ...
    samtools sort -@ 16 ${run}.fulllinker.chimeric.paired.UxxU.nr.bam \
        -o ${run}.fulllinker.chimeric.paired.UxxU.nr.sorted.bam
    samtools sort -@ 16 ${run}.fulllinker.chimeric.single.UxxU.nr.bam \
        -o ${run}.fulllinker.chimeric.single.UxxU.nr.sorted.bam
    samtools sort -@ 16 ${run}.FullLinker.NonChimeric.paired.UxxU.nr.bam \
        -o ${run}.FullLinker.NonChimeric.paired.UxxU.nr.sorted.bam
    samtools sort -@ 16 ${run}.FullLinker.NonChimeric.single.xx.nr.bam \
        -o ${run}.FullLinker.NonChimeric.single.xx.nr.sorted.bam
